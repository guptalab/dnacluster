...
int main()
{
    ...
    string Time_taken_path = "edges_generated\\Time_taken.txt";


    string input_path = "ERR1816980_converted.txt";
    ...
    string output_path = "edges_generated\\thresold_" + to_string(thrr) + ".csv";
